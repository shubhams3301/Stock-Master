...
class billClass:
    def __init__(self,root):
        ...
        title=Label(self.root,text="Stock Master",image=self.icon_title,compound=LEFT,font=("times new roman",40,"bold"),bg="#010c48",fg="white",anchor="w",padx=20).place(x=0,y=0,relwidth=1,height=70)
        ...
        #==clock==
        self.lbl_clock=Label(self.root,text="Welcome to SDD Inventory Management System\t\t Date: DD-MM-YYYY\t\t Time: HH:MM:SS",font=("times new roman",15,),bg="#4d636d",fg="white")
        ...
        ProductFrame2.place(x=2,y=43,width=398,height=90)
        ...
        self.product_Table.column("price",width=68)
        self.product_Table.column("qty",width=53)
        ...
        btn_eq=Button(Cal_Frame,text='=',font=('arial',15,'bold'),command=self.perform_cal,bd=5,width=4,pady=16,cursor="hand2").grid(row=4,column=2)
        ...
        billFrame.place(x=953,y=110,width=410)

        BTitle=Label(billFrame,text="Customer Bill",font=("goudy old style",20,"bold"),bg="#FF5233",fg="white").pack(side=TOP,fill=X)
        ...
        btn_print=Button(billMenuFrame,text='Print',command=self.print_bill,cursor='hand2',font=("goudy old style",15,"bold"),bg="maroon",fg="white")
        ...
        btn_generate=Button(billMenuFrame,text='Generate/Save Bill',command=self.generate_bill,cursor='hand2',font=("times new roman",15,"bold"),bg="#009688",fg="white")
        btn_generate.place(x=246,y=80,width=160,height=50)

        #==footer==
        #footer=Label(self.root,text="IMS-SDD Inventory Management System | Developed SDD Team Grp:6\n For any Technical Issue Contact:7715xxx799",font=("times new roman",11),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
...
#========All Function========= 
    ...
    def generate_bill(self):
        if self.var_cname.get()=='' or self.var_contact.get()=='':
            ...
            fp.close()
            messagebox.showinfo('Saved',"Bill has been generated/Saved in Backend DB")
            self.chk_print=1
    ...
    def bill_top(self):
        ...
        bill_top_temp=f'''
\t\tStock Master
\t Phone No. 77150***99 , Mumbai-400101
{str("="*47)}
...
{str("="*47)}\n
    ...
    def update_date_time(self):
        ...
        self.lbl_clock.config(text=f"Welcome to Stock Master\t\t Date: {str(date_)}\t\t Time: {str(time_)}")
