...
class supplierClass:
    def __init__(self,root):
        ...
        #===Title===
        title=Label(self.root,text="Supplier Detials",font=("goudy old style",20,"bold"),bg="#0f4d7d",fg="white").place(x=50,y=10,width=1000,height=40)

        #===content===
        #====row1====
        lbl_supplier_invoice=Label(self.root,text="Invoice",font=("goudy old style",15),bg="white").place(x=50,y=80)
