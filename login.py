...
class Login_System:
    def __init__(self,root):
        self.root=root
        self.root.title("Login System | Developed By SDD TEAM")
        ...
        lbl_forget=Label(register_frame,text="Sahu Technologies",font=("times new roman",13),bg="white").place(x=0,y=20,relwidth=1)
