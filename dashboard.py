...
class IMS:
    def __init__(self,root):
        ...
        #==clock==
        self.lbl_clock=Label(self.root,text="Welcome to Stock Master\t\t Date: DD-MM-YYYY\t\t Time: HH:MM:SS",font=("times new roman",15,),bg="#4d636d",fg="white")
        ...
        #==footer==
        lbl_footer=Label(self.root,text="Stock Master Developed SDD TEAM\n For any Technical Issue Contact:7715xxx799",font=("times new roman",12),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
        self.update_content()
#============================================================================
    def employee(self):
